...
-- Étape 4 : Insertion de 5 lignes de données dans test_table
...
-- Étape 5 : Insertion de données dans la table Hotel
INSERT INTO hotel (name, pricePerNight, latitude, longitude, beach, rating, address, islandId, rank) VALUES
